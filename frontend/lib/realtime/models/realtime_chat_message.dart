class RealtimeChatMessage {
  ...
  final bool isRead;
  final List<RealtimeReadBy> readBy;
  ...
  factory RealtimeChatMessage.fromJson(Map<String, dynamic> json) {
    return RealtimeChatMessage(
      ...
      readBy: (json['readBy'] as List?)
          ?.map((item) => RealtimeReadBy.fromJson(item))
          .toList() ?? [],
...
class RealtimeReadBy {
  ...
  factory RealtimeReadBy.fromJson(Map<String, dynamic> json) {
    return RealtimeReadBy(
      userId: json['userId'] ?? '',
