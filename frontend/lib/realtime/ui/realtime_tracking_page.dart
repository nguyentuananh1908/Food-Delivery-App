...
class _RealtimeTrackingPageState extends State<RealtimeTrackingPage> {
  ...
  void _updateMapLocation(RealtimeLocationData locationData) {
  ...
  void _updateMapWithHistory(List<RealtimeLocationData> history) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Consumer<RealtimeLocationProvider>(
