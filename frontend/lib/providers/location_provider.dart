...
class LocationProvider with ChangeNotifier {
  ...
  Future<List<LocationData>> getLocationHistory(String orderId) async {
    try {
      final response = await _apiService.get('/location/order/$orderId/history');
      final historyData = response['locationHistory'] as List;
      
      return historyData.map((json) => LocationData.fromJson(json)).toList();
    } catch (e) {
  ...
  Future<LocationData?> getCurrentLocationForOrder(String orderId) async {
    try {
